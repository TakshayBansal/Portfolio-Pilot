...
def load_data(asset_type):
    ...
    # Handle "stocks" asset type specifically for SPY data
    elif asset_type == "stocks":
        ticker_symbol = "SPY" # Use SPY as the general stock market representation
        print(f"ℹ️ Asset type 'stocks' requested, fetching data for {ticker_symbol}")
        # Check cache first for SPY
        ...
        # If not in cache or stale, fetch SPY from yfinance
        ...
        try:
            ...
            data['Ticker'] = ticker_symbol # Add Ticker column for consistency, though it's SPY
